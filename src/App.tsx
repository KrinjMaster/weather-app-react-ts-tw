...
const App = () => {
  ...
  return (<>
      <section id="home" className="h-screen w-screen p-4 flex flex-col text-center align-center md:px-10 lg:p-24">
        <div className="">
          <h1 className="text-4xl xl:text-6xl font-thin text-white">Krinj Master <span className="font-bold">Forecast</span></h1>
          <p className="text-sm xl:text-lg text-white">Enter a city to get a weather forecast!</p>
          <div className="flex relative justify-center xl:text-2xl">
            ...
            {DataState.dataState &&  <div className="absolute left-0 right-0 mt-0.5 ml-auto mr-auto bg-white bg-opacity-10 rounded-2xl h-[18rem] xl:h-[24rem] w-[23rem] xl:text-3xl xl:w-[38rem] align-middle text-white">
              <div className="flex flex-col mt-[45px] xl:gap-7">
